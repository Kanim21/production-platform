...
# Auto-rotation deferred — see docs/adr/004-rds-secret-rotation.md
# Recommended path: AWS SAR SecretsManagerRDSPostgreSQLRotationSingleUser template
# Manual rotation: docs/runbooks/rds-secret-rotation.md
